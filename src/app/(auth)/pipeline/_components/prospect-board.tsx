...
import { PRIORITY_META, PRIORITY_OPTIONS, STATUS_COLUMNS } from "./crm-constants";
...
/** Kanban de prospecção manual do CRM (empresas por status, drag-and-drop). */
export function ProspectBoard({ onOpenCompany }: ProspectBoardProps) {
  ...
  return (
    <div>
      <div className="flex flex-wrap gap-2 mb-4">
        ...
        <Button
          className="bg-[#eca826] text-white hover:bg-[#d4951e] font-medium ml-auto"
