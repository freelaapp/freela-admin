...
function CyclesScreen() {
  ...
  const { data: cycles = [], isLoading } = useVipCycles(activeFilter === "all" ? undefined : activeFilter === "true");
          ...
          <table className="w-full text-[13px]">
            <thead className="bg-[#F8FAFC] text-left text-[12px] uppercase tracking-wide text-[#64748B]">
              <tr>
                ...
                <th className="px-3 py-2">Cidades · funções</th>
                <th className="px-3 py-2">Vagas · convites</th>
